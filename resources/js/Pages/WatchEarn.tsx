        ...
        <TabContext value={value}>
          <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
            <TabList onChange={handleChange} aria-label="lab API tabs example">
              <Tab label="Pay per view" value="1" sx={TabStyle} />
              <Tab label="watch & earn" value="2" sx={TabStyle} />
              <Tab label="valyou playlist" value="3" sx={TabStyle} />
              <Tab label="promoted videos" value="4" sx={TabStyle} />
              <Tab label="promoted audios" value="5" sx={TabStyle} />
            </TabList>
          </Box>
        </TabContext>
